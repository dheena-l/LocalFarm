...
import vegs from "../assets/products-hero.jfif";
import { useNavigate } from "react-router-dom";
import { fetchProducts, getInitialProducts, getProductImageUrl } from "../services/productsService";
import usePageMeta from "../hooks/usePageMeta";

function Products() {
  usePageMeta(
    "Our Products | LocalFarm — Milk, Eggs, Coconuts & More",
    "Browse LocalFarm's full range of naturally grown farm products: fresh milk, country eggs, coconuts, paddy, groundnuts, bananas, and organic fertilizer."
  );
