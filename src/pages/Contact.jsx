...
function Contact() {
  usePageMeta(
    "Contact Us | LocalFarm — Cheyyur, Chengalpattu, Tamil Nadu",
    "Get in touch with LocalFarm in Cheyyur, Chengalpattu for fresh farm products, delivery, and availability. Reach us by WhatsApp or the form below."
  );
  ...
  const handleSubmit = async (e) => {
    ...
    // No backend anymore: the message is sent straight to the farm on WhatsApp.
    ...
    setStatusMessage({ type: "success", text: "Opening WhatsApp so you can send your message directly to the farm." });
    setFormData({
      name: "",
      email: "",
      phone: "",
