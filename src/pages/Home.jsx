...
import { fetchProducts, getInitialProducts } from '../services/productsService';
...
function Home() {
    usePageMeta(
      "LocalFarm | Fresh Organic Farm Products, Village Grown Daily",
      "LocalFarm delivers fresh cow milk, country eggs, coconuts, organic manure, and naturally raised farm products straight from our village fields."
    );
